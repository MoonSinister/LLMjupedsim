...
def homogenize_agent_profiles(spawn_plans):
    """Replace profile variation while preserving stable agent identities."""
    canonical = {
        "profile_id": "homogeneous_profile",
        "role": "visitor",
        "subtype": "homogeneous",
        "attribute": "identical experimental control profile",
        "motivation": "follow the assigned route",
        "preferences": [],
        "personal_variation": "",
        "desired_speed_mps": 1.34,
        "default_wait_seconds": 0,
        "source": "homogeneous_control",
        "history_hint": "",
        "intent_hint": "",
        "memory_hint": "",
        "metadata": {"ablation": "no_profile_variation"},
        "schema_version": "1.0",
    }
    for agent in planned_agents(spawn_plans):
        agent["profile"] = dict(canonical)
